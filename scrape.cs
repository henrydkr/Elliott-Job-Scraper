...
namespace elliottjobscraper
{
    class Scrape
    {
        ...
        {
            // Define the URL of the jobs page on the Elliot Electric Kiosk
            ...
            // Find the table on the page that contains the job listings
            ...
            if (table != null)
            {
                ...
                for (int i = 0; i < rows.Count(); i++)
                {
                    ...
                    for (int j = 0; j < cells.Count(); j++)
                    {
                        ...
                        // Write the cell value to the corresponding cell in the worksheet
        ...
        public static void ScrapeLinks()
        {
            ...
            // Find the table on the page that contains the job links
            var table = doc.DocumentNode.Descendants("table").FirstOrDefault(t => t.GetAttributeValue("id", "") == "jobs2");
            ...
            if (table != null)
            {
                ...
                if (jobLinks.Count > 0)
                {
                    ...
                    // Write the job links to the worksheet
